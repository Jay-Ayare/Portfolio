    ...
    >
      ...
      Hello; <br/> I&apos;m
        ...
        <div className="mt-8 space-x-4">
            ...
            <Link prefetch={false} href={"/"} className="relative inline-block text-lg group" aria-label="resume">
              <span className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
                <span className="absolute inset-0 w-full h-full px-2 py-1 rounded-lg bg-gray-50"></span>
                <span className="absolute left-0 w-48 h-48 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-gray-900 group-hover:-rotate-180 ease"></span>
        ...
        <div className=" mt-5 h-auto flex  items-center justify-between">
          <a href="mailto:jay.ayare2@gmail.com" aria-label="mail">
            <p className="flex flex-row items-center my-[20px] cursor-pointer">
              <SiGmail />
              <span className="text-[20px] ml-[6px]">Gmail</span>
            </p>
          </a>
          <a href="https://github.com/Jay-Ayare" aria-label="github">
            <p className="flex flex-row items-center my-[20px] cursor-pointer">
              <RxGithubLogo />
              <span className="text-[20px] ml-[6px]">Github</span>
            </p>
          </a>
          <a href="https://www.linkedin.com/in/jay-ayare-86651a23b/" aria-label="linkedin">
            <p className="flex flex-row items-center my-[20px] cursor-pointer">
              <FaLinkedin />
